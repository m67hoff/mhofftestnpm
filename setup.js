...
const SERVICE = 'mhofftestnpm.service'
    ...
    switch (process.platform) {
        case "linux":
            ...
            try {
                ...
                // restart service               
                log.info('setup', 'restarting mhofftestnpm service')
                child_process.execSync('systemctl restart mhofftestnpm', { "timeout": 2000 })

                // status service             
                log.info('setup', 'service status (systemctl status mhofftestnpm):')
